...
app.post('/api/registrate/user', (req, res) => {
  ...
  (SQL_error, SQL_result) => { 
       ...
       res.body(`[{ "Name":"${req.body.name}","Surname": ${req.body.surname},"Email": "${req.body.Email}","Login": "${req.body.Email}","Photo": "${req.body.photo}","Telephone": "${req.body.telephone}", "Password": "${req.body.password}",Country": "${req.body.country}" }]`)
